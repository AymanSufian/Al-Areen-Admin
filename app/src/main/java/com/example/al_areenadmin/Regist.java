                ...
                if (task.isSuccessful()){
                    ...
                    firebaseDatabase.getInstance().getReference("Users").child(mAuth.getInstance().getCurrentUser().getUid()).setValue(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull  Task<Void> task) {
                            if (task.isSuccessful()){
                                Toast.makeText(Regist.this,"Registered Successfully !",Toast.LENGTH_LONG).show();
                            }
                            else {
                                Toast.makeText(Regist.this,"Failed to Registered ! Try again",Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(Regist.this,"Failed to Registered ",Toast.LENGTH_LONG).show();
